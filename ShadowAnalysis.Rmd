...
## Analysis
The length of the ladder at the point shown on the reference point of the Length plot is equivalent to the height of the International Space Stations orbit or 254 miles (408773 m). 
...
ggplot(plot.dat, 
       aes(x = xval, y = values))+ geom_line(color="violet")+ ggtitle("Ladder Length Plot")+ xlab("Time(s)")+ ylab("Length(m)")+ geom_point(shape=1, aes(x=4836.77, y=408773), colour="black", size=2)
...
options(scipen=999)
t = seq(0, 60*60*6, 1)
acc = 460*tan(460/6378000*t)*1/cos(460/6378000*t)
values = c(acc)
# Create a variable that indicates what is being plotted
...
ggplot(plot.dat, 
       aes(x = xval, y = values))+ geom_line(color="cyan")+ ggtitle("Ladder Instantaneous Velocity Plot")+ xlab("Time(s)")+ ylab("Velocity(m/s)")+ geom_point(shape=1, aes(x=18954.04, y=11000), colour="black", size=2)
...
ggplot(plot.dat, 
       aes(x = xval, y = values))+ geom_line(color="green")+ ggtitle("Ladder Instantaneous Acceleration Plot")+ xlab("Time(s)")+ ylab("Acceleration(m/s^2)")+ geom_point(shape=1, aes(x=20539.47, y=46.2), colour="red", size=2)
```
