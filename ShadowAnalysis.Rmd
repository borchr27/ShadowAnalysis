...
Giving Equation \ref{eq:len}. The length of the ladder at the point shown on the reference point of the Length Plot is equivalent to the distance of the International Space Station from the surface of the Earth or 254 \(miles\) (408,773 \(m\)). 
...
\newpage
Taking the derivative of the position equation gives the velocity equation. The circle on this plot signifies the escape velocity for a Falcon 9 rocket launch, roughly 11,000\(\frac{m}{s}\).
