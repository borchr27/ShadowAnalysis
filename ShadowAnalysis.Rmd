...
ggplot(plot.dat, 
       aes(x = xval, y = values))+ geom_line(color="cyan")+ ggtitle("Velocity Plot")+ xlab("Time(s)")+ ylab("Velocity(m/s)")+ geom_point(shape=1, aes(x=18954.04, y=11000), colour="black", size=2)
...
ggplot(plot.dat, 
       aes(x = xval, y = values))+ geom_line(color="green")+ ggtitle("Acceleration Rate Over Time")+ xlab("Time(s)")+ ylab("Acceleration(m/s^2)")+ geom_point(shape=1, aes(x=20539.47, y=46.2), colour="red", size=2)
